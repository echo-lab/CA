...
const categorizeOffScriptUtterances = async (formattedUtterances, bookPageText, currentPageQuestion, bookText, currentPageNumber, imageDescription) => {
    const BASE_URL = process.env.REACT_APP_API_BASE || 'https://localhost:5001';

    const payload = { formattedUtterances, bookPageText, currentPageQuestion, bookText, currentPageNumber, imageDescription };
